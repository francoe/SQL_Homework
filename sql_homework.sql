...
staff.last_name,
staff.first_name,
SUM(payment.amount) as "Total Payment Collected"
FROM staff
INNER JOIN payment ON staff.staff_id = payment.staff_id
WHERE payment.payment_date LIKE "2005-05%"
...
SELECT
COUNT(inventory.film_ID) AS "Inventory Count"
FROM film
...
SELECT
customer.last_name AS "First Name",
customer.first_name AS "Last Name",
...
-- names and emails of all Canadian actors
SELECT
customer.first_name,
customer.last_name,
customer.email
...
LEFT OUTER JOIN inventory ON film_category.film_id = inventory.film_id 
